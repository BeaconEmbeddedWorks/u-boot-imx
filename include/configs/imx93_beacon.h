...
#ifndef __IMX93_BEACON_H
#define __IMX93_BEACON_H
...
#define DEFAULT_SDRAM_SIZE_MB	(1024) 			/* 1GB Minimum DDR4, see get_dram_size */
#define BEACON_EEPROM_DRAM_START (PHYS_SDRAM + ((DEFAULT_SDRAM_SIZE_MB * SZ_1M) >> 1))
#define DEFAULT_SDRAM_SPEED_MTS	(0) 			/* Not yet supported for imx93_beacon, see get_dram_speed */
#define BEACON_EEPROM_I2C_NAME "i2c@44340000" 	/* lpi2c1 see imx93.dtsi */
...
#define JH_ROOT_DTB    "imx93-beacon-kit.dtb"
...
#define CFG_EXTRA_ENV_SETTINGS		\
	...
	"loadfdt=${loadcmd} mmc ${mmcdev}:${mmcpart} ${fdt_addr_r} ${fdtfile}\0" \
	"loadcntr=${loadcmd} mmc ${mmcdev}:${mmcpart} ${cntr_addr} ${cntr_file}\0" \
